...
SYSTEMD_SETUP() {
  ...
  sed -i -e 's/MONGO_DNSNAME/dev-mongodb.devops321.online/' -e 's/REDIS_ENDPOINT/dev-redis.devops321.online/' -e 's/CATALOGUE_ENDPOINT/dev-catalogue.devops321.online/' -e 's/MONGO_ENDPOINT/dev-mongodb.devops321.online/' /home/roboshop/${COMPONENT}/systemd.service &>>$LOG
