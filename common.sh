...
SYSTEMD_SETUP() {
  ...
  sed -i -e 's/MONGO_DNSNAME/dev-mongodb.devops321.online/' -e 's/REDIS_ENDPOINT/redis.devops321.online/' -e 's/CATALOGUE_ENDPOINT/catalogue.devops321.online/' /home/roboshop/${COMPONENT}/systemd.service &>>$LOG
